...
# BASE_URL = "https://part-time-entrepreneur.com/"
BLOG_EMAIL = "eracle@posteo.eu"
BLOG_DESCRIPTION = "My journey to financial indipendence through bootstraped entrepreneural projects."  # (translatable)
...
# Config for dopetrope:
THEME_CONFIG = {
    DEFAULT_LANG: {
    }
}
USE_BUNDLES = False  # todo: delete afterwards
...
# (translatable)
CONTENT_FOOTER = """
<li>The Part-time entrepreneur.</li>
<li>Contents &copy; {date} <a href="mailto:{email}">{author}</a></li>
<li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
<li>Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a></li>
{license}
"""
...
# is in the manual.
COMMENT_SYSTEM_ID = "part-time-entrepreneur"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-XPRNG9L3E4"></script>
<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'G-XPRNG9L3E4');
</script>
"""
...
# GLOBAL_CONTEhow-to-keep-learning-costs-low-as-a-solo-entrepreneurXT as parameter when the template is about to be
# rendered
